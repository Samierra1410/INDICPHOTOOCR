...
# === CONFIG ===
output_folder = "my_photos/PAKKA_OCR_OUTPUTS"

# === Load expected counts ===
with open("/Users/samierraarora/IndicPhotoOCR/IndicPhotoOCR/IndicPhotoOCR2/expected_counts.json", "r", encoding="utf-8") as f:
...
for filename in sorted(os.listdir(output_folder)):
    if filename.lower().endswith(".json") and filename in expected_counts:
        ...
        if expected_count == 0:
            print(f"{filename}: ⚠️ Expected count is 0, skipping.")
            continue
